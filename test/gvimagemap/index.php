...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo $base_href; ?>styles.css" />
	<script type="text/javascript" src="<?php echo $base_href; ?>prototype/prototype.js"></script>
	<script type="text/javascript" src="<?php echo $base_href; ?>scripts.js"></script>
</head>
<body>
